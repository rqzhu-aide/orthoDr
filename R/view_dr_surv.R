#' @title 2D or 3D view of survival data on reduced dimension
#' @name view_dr_surv
#' @export
...
#' @return Invisible \code{NULL}. Called for its side-effect (producing a plot).
#'
#' @references
...
#'
#' @seealso \code{\link{orthoDr_surv}}, \code{\link{distance}}
#' @examples
